...
- [ ] Connect testoutput
- [X] Do not have any bias voltage to module interface;
  - BV must be connected on the module adapter itself
- [ ] Look at the BGA196 footprint.. what is going on with it???
