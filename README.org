...
- [X] Parallelize LinPol Outputs
- [ ] Fix I2C note
- [ ] Remove I2C programmer port
- [ ] Increase BV granularity to 1 per ETROC
- [ ] Increase LV granularity to 1 per ETROC ? add FETs or something?
- [X] Remove EFUSEPOWER pulldown R132
- [ ] Add EFUSEPOWER test point ?
- [X] Fix PiGBT Connector Pinout
- [ ] Change mechanical envelope to reflect latest design
...
- [-] Addition of LEDs
  ...
  + [ ] Connect LPGBT GPIO to LED
  + [ ] Connect SCA GPIO to LED
- [X] lpGBT v1 Changes:
...
- [ ] Latest module pinout (monitor 1x VREF and VTEMP per ETROC)
